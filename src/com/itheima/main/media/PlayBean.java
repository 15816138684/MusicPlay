...
public class PlayBean {
    ...
    public PlayBean(int id, String soundName, String artList, String album, String length, String time, Label labDelete, WritableImage image, int totalSeconds, String filePath, MediaPlayer mediaPlayer, String lrcPath) {
        this.id = id;
